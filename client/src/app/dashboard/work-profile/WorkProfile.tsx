  ...
  return (
    <div className="overflow-hidden bg-white shadow-xl   rounded-lg">
        <div className=" px-4 py-6 sm:px-6 sm:flex sm:items-center sm:justify-between">
            <h3 className="text-base font-semibold text-gray-900">Work Profile</h3>
      ...
      <div className="border-t border-gray-100">
        <dl className="divide-y divide-gray-100">
          ...
          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            <dt className="text-sm font-medium text-gray-900">Current Job Title</dt>
          ...
          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">
              Her name was Lola, she was a show girl. With yellow diamonds in her hair and her dress came down to there
            </dd>
          </div>
          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
