  ...
  return (
    <>
      {/*
        ...
        ```
      */}
      <div className="flex bg-gray-50 min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
          <div className="bg-white px-6 py-12 shadow-sm sm:rounded-lg sm:px-12">
            ...
            <p className="mt-10 text-center text-sm/6 text-gray-500">
              Not a member?{' '}
              <Link href="/auth/create-account" className="font-semibold text-indigo-600 hover:text-indigo-500">
                Create an account
              </Link>
            </p>
